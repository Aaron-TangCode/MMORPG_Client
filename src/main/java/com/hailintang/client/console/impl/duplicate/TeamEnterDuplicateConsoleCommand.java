...
/**
 * @ClassName TeamEnterDuplicateConsoleCommand
 * @Description 攻击怪兽
 * @Author DELL
 * @Date 2019/8/12 12:02
 * @Version 1.0
 */
public class TeamEnterDuplicateConsoleCommand implements ConsoleCommand {
    @Override
    public void exec(Scanner scanner, Channel channel) {
        ...
        if (Strings.isNullOrEmpty(mapName)) {
            System.out.println("尚未指令，请重新发送 TeamEnterDuplicate 指令");
            return;
        }
        //打包成protobuf格式
